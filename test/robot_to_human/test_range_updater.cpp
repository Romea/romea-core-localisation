...
TEST(TestR2HKFRangeUpdater, mahalanobisRejectionKeepsPreviousState)
{
  auto meta_state = make_running_state();
  FSMState fsm_state = FSMState::RUNNING;
  Updater updater("range_updater", 10.0, TriggerMode::ALWAYS, 1.0, false);
