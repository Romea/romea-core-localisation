...
#include "romea_core_localisation/robot_to_world_25D/R2WLevelArmCompensation25D.hpp"
...
//-----------------------------------------------------------------------------
LevelArmCompensation25D::LevelArmCompensation25D()
...
//-----------------------------------------------------------------------------
void LevelArmCompensation25D::compute(
...
//-----------------------------------------------------------------------------
const Eigen::Vector3d & LevelArmCompensation25D::getPosition()const
{
  return position_;
}

//-----------------------------------------------------------------------------
const Eigen::Matrix3d & LevelArmCompensation25D::getPositionCovariance()const
{
  return positionCovariance_;
}

//-----------------------------------------------------------------------------
const Eigen::Matrix3d & LevelArmCompensation25D::getJacobian()const
{
  return jacobian_;
}
