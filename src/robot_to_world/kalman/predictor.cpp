...
//-----------------------------------------------------------------------------
void R2WKFPredictor::predictAddOn_(
  const AddOn & previousAddOn,
  AddOn & currentAddOn)
{
  currentAddOn.roll = previousAddOn.roll;
  currentAddOn.pitch = previousAddOn.pitch;
  currentAddOn.roll_pitch_variance = previousAddOn.roll_pitch_variance;
