...
{
  Inn_ = betweenMinusPiAndPi(current_observation.Y() - current_state.X(MetaState::ORIENTATION_Z));
  ...
  AddOn & /*current_add_on*/)
{
  ...
  current_state.P(MetaState::ORIENTATION_Z, MetaState::ORIENTATION_Z) = current_observation.R();
