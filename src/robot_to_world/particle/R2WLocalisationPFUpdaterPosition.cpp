//romea
#include "romea_localisation/robot_to_world/particle/R2WLocalisationPFUpdaterPosition.hpp"
...
//--------------------------------------------------------------------------
void R2WLocalisationPFUpdaterPosition::update(const Duration &duration,
...
//-----------------------------------------------------------------------------
void R2WLocalisationPFUpdaterPosition::update_(const Duration & duration,
...
//-----------------------------------------------------------------------------
bool R2WLocalisationPFUpdaterPosition::set_(const Duration & duration,
...
//-----------------------------------------------------------------------------
void R2WLocalisationPFUpdaterPosition::computeLevelArms_(Observation const & currentObservation,
