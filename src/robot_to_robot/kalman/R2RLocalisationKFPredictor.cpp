...
//-----------------------------------------------------------------------------
void R2RLocalisationKFPredictor::predict_(
  const R2RLocalisationKFMetaState & previousMetaState,
...
//-----------------------------------------------------------------------------
void R2RLocalisationKFPredictor::predictState_(
...
//-----------------------------------------------------------------------------
void R2RLocalisationKFPredictor::predictAddOn_(
  ...
  AddOn & currentAddOn)
{
  ...
  currentAddOn.travelledDistance = previousAddOn.travelledDistance + std::sqrt(
    vxfdT_ * vxfdT_ + vyfdT_ * vyfdT_);
  currentAddOn.lastExteroceptiveUpdate = previousAddOn.lastExteroceptiveUpdate;
}

//-----------------------------------------------------------------------------
bool R2RLocalisationKFPredictor::stop_(
