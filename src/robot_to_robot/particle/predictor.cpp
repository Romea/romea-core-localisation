...
//-----------------------------------------------------------------------------
void R2RPFPredictor::drawFollowerInputs(const Input & previousInput)
{
...
//-----------------------------------------------------------------------------
void R2RPFPredictor::drawLeaderInputs(const Input & previousInput)
{
  ...
  AddOn & currentAddOn)
{
    ...
    currentAddOn.robot_trajectory[0].norm() > 0.1)
  {
    ...
    currentAddOn.leader_trajectory.append(Eigen::Vector2d(x, y));
  }
  ...
  const MetaState & meatastate)
{
  ...
  double travelledDistanceInDeadReckoningMode = meatastate.addon.travelled_distance -
