...
//-----------------------------------------------------------------------------
R2RPFResults::R2RPFResults(const size_t & numberOfParticles)
: R2RResultsBase<R2RPFMetaState>(numberOfParticles),
  weight_sum_(0),
  ...
  mean_centered_particles_(
    R2RPFMetaState::State::RowMajorMatrix::Zero(STATE_SIZE, numberOfParticles))
{
}
