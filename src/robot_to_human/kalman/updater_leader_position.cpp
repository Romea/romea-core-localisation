  ...
  AddOn & current_add_on)
{
  ...
  if (
    ...
    current_state.X().segment<2>(MetaState::LEADER_POSITION_X) = current_observation.Y();

    current_state.P().block<2, 2>(MetaState::LEADER_POSITION_X, MetaState::LEADER_POSITION_X) =
