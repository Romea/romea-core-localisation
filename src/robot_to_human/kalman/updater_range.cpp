  ...
  AddOn & currentAddOn)
{
  ...
  double aprioriRange = (currentState.X() - currentObservation.initiator_position.head<2>()).norm();
  H_ = (currentState.X() - currentObservation.initiator_position.head<2>()).transpose() /
    aprioriRange;
  ...
  if (log_file_.is_open()) {
    ...
    log_file_ << currentObservation.initiator_position(0) << ",";
    log_file_ << currentObservation.initiator_position(1) << ",";
  }
  ...
  if (log_file_.is_open()) {
    ...
    log_file_ << this->mahalanobisDistance_ << ",";
    log_file_ << success << ",\n";
  }
