...
#ifndef ROMEA_CORE_LOCALISATION__UPDATER_TWIST_HPP_
#define ROMEA_CORE_LOCALISATION__UPDATER_TWIST_HPP_
...
private:
  ...
  {
    input.U().template segment<3>(MetaState::LINEAR_SPEED_X_BODY) = current_observation.Y();
...
#endif  // ROMEA_CORE_LOCALISATION__UPDATER_TWIST_HPP_
