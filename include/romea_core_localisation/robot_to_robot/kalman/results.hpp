...
class R2RKFResults : public R2RResultsBase<R2RKFMetaState>
{
public:
  R2RKFResults();
  virtual ~R2RKFResults() = default;
...
#endif  // ROMEA_CORE_LOCALISATION__ROBOT_TO_ROBOT__KALMAN__RESULTS_HPP_
