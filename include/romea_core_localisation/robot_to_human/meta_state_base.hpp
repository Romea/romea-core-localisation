...
#ifndef ROMEA_CORE_LOCALISATION__ROBOT_TO_HUMAN__META_STATE_BASE_HPP_
#define ROMEA_CORE_LOCALISATION__ROBOT_TO_HUMAN__META_STATE_BASE_HPP_
...
struct R2HMetaStateBase {
  ...
  struct AddOn {
    ...
    RingOfEigenVector<Eigen::Vector2d> leader_trajectory;
    RingOfEigenVector<Eigen::Vector2d> robot_trajectory;
    double travelled_distance;
  };

  R2HMetaStateBase();
  virtual ~R2HMetaStateBase() = default;
...
#endif  // ROMEA_CORE_LOCALISATION__ROBOT_TO_HUMAN__META_STATE_BASE_HPP_
