...
#ifndef ROMEA_CORE_LOCALISATION__ROBOT_TO_WORLD__RESULTS_BASE_HPP_
#define ROMEA_CORE_LOCALISATION__ROBOT_TO_WORLD__RESULTS_BASE_HPP_
...
public:
  ...
  virtual const double & get_yaw() const = 0;
  virtual const double & get_yaw_variance() const = 0;

  virtual Eigen::Vector3d get_pose() const = 0;
  virtual Eigen::Matrix3d get_pose_covariance() const = 0;
  ...
  virtual Pose2D to_pose2d() const = 0;
  virtual Pose3D to_pose3d() const = 0;

  virtual PoseAndTwist2D to_pose_and_body_twist2d() const = 0;
  virtual PoseAndTwist3D to_pose_and_body_twist3d() const = 0;
...
#endif  // ROMEA_CORE_LOCALISATION__ROBOT_TO_WORLD__RESULTS_BASE_HPP_
