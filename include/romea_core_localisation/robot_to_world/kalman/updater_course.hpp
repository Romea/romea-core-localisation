...
class R2WKFUpdaterCourse : public UpdaterExteroceptive, public EKFUpdaterBase<double, 3, 1>
{
public:
...
#endif  // ROMEA_CORE_LOCALISATION__ROBOT_TO_WORLD__KALMAN__UPDATER_COURSE_HPP_
